...
players.forEach((player) => {
  ...
  playersContainer.innerHTML += `
    ...
    player.img ?? "../assets/playerunknown.png"
  }')" class="bg-no-repeat bg-cover w-3xs aspect-3/4 overflow-hidden rounded-md hover:outline-2 hover:outline-sky-50 hover:scale-102 player-card">
      <div class="bg-linear-to-t from-black/80 from-30% to-black/0 w-full h-full flex flex-col text-center p-2">
        ...
        <div class="mt-auto font-black text-3xl">${player.ign}</div>
